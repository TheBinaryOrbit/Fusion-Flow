...
const Header = () => {
    return (
        <header className="w-full h-[8vh] py-3 bg-white  z-50 sticky top-0">
            <div className="max-w-7xl flex items-center mx-auto gap-20 relative z-50">
                <div>
                    <Image src={img} width={100} height={50} alt="logo" />
                </div>
                <nav>
                    <ul className="style-none flex gap-5 text-black">
                        <li className="group relative">
                            ...
                            <ul className="absolute top-[100%] mt-3 bg-gray-900 w-56 hidden group-hover:block p-2 font-[500] capitalize rounded-xl space-y-2 shadow-lg z-50">
                        ...
                        <li className="group relative">
                            ...
                            <ul className="absolute top-[100%] mt-3 bg-gray-900 w-64 hidden group-hover:block p-2 font-[500] capitalize rounded-xl space-y-2 shadow-lg z-50">
                ...
                <nav className="ml-auto flex gap-4 text-black">
